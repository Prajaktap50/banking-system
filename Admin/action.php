...
$a=$conn->query("insert into admin(Aname,Aemail,Apwd,Amob) values ('$content','$content1','$content2','$content3')");
...
$a=$conn->query("update admin set Aname='$ucontent1', Aemail='$ucontent2', Apwd='$ucontent3', Amob='$ucontent4' where Aid=$ucontent");
